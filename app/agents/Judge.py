...
from app.agents.system_prompts import get_judge_prompt, get_judge_prompt2

class JudgeInput(BaseModel):
    question: str = Field(description = "Question to evaluate")
    golden_answer: str = Field(description = "Ideal answer to the question to compare the actual answer with")
...
class JudgeOutput(BaseModel):
    ...
    summary: str = Field(description="Brief evaluation of the generated answer and explanation of how you decided on the score")
...
class JudgeAgent:
    ...
    def initialize_agent(self):
        ...
        agent = Agent(
            ...
            system_prompt=get_judge_prompt2()
        )
        return agent
